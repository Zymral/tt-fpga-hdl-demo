...
logic [7:0] FpgaPins_Fpga_CALC_digit_a3;
...
logic [3:0] FpgaPins_Fpga_CALC_op_a1,
...
logic [3:0] FpgaPins_Fpga_TB_op_a2;
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $op.
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_op_a2[3:0] <= FpgaPins_Fpga_CALC_op_a1[3:0];
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               (* keep *) logic [3:0] \///?$valid_or_reset@1$op ;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 170 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 173 as: m5+board(/top, /fpga, 7, $, , calc)
         ...
         //_/fpga
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  ...
                  //_@1
                     //input
                     //$valid = $reset ? 1'b0 : >>1$valid + 1'b1; old counter
                     ...
                     //logic
                     //_?$valid_or_reset
                        assign FpgaPins_Fpga_CALC_op_a1[3:0] = ui_in[6:4];
                  ...
                  //_@2
                     ...
                     assign FpgaPins_Fpga_CALC_out_a2[7:0] =
                       FpgaPins_Fpga_CALC_reset_a2 ? 32'b0:
                       !FpgaPins_Fpga_CALC_valid_a2 ? FpgaPins_Fpga_CALC_out_a3:
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b100 ? FpgaPins_Fpga_CALC_mem_a2:
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b011 ? FpgaPins_Fpga_CALC_quot_a2:
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b010 ? FpgaPins_Fpga_CALC_prod_a2:
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b001 ? FpgaPins_Fpga_CALC_diff_a2:
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b101 ? FpgaPins_Fpga_CALC_sum_a2:
                       //default
                       FpgaPins_Fpga_CALC_out_a2;
                     // mem mux
                     assign FpgaPins_Fpga_CALC_mem_a2[7:0] =
                       FpgaPins_Fpga_CALC_reset_a2 ? 8'b0:
                       !FpgaPins_Fpga_CALC_valid_a2 ? FpgaPins_Fpga_CALC_mem_a2:
                       FpgaPins_Fpga_CALC_op_a2[2:0] == 3'b101 ? FpgaPins_Fpga_CALC_out_a4:
                     //default
                     FpgaPins_Fpga_CALC_mem_a2;
                  //_@3
                     assign FpgaPins_Fpga_CALC_digit_a3[7:0] = FpgaPins_Fpga_CALC_out_a3[7:0];
                     assign uo_out =
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h0 ? 8'b00111111: //0
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h1 ? 8'b00000110: //1
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h2 ? 8'b01011011: //2
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h3 ? 8'b01001111: //3
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h4 ? 8'b01100110: //4
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h5 ? 8'b01101101: //5
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h6 ? 8'b01111101: //6
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h7 ? 8'b00000111: //7
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h8 ? 8'b01111111: //8
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'h9 ? 8'b01101111: //9
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'ha ? 8'b01110111: //a
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'hb ? 8'b01111100: //b
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'hc ? 8'b00111001: //c
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'hd ? 8'b01011110: //d
                      FpgaPins_Fpga_CALC_digit_a3[7:0] == 4'he ? 8'b01111001: //e
                                            8'b01110001; //f
            
            
               //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 4   // Instantiated from top.tlv, 110 as: m5+cal_viz(@2, /fpga)
                  // Only for Makerchip.
                  //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 9   // Instantiated from /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv, 6 as: m4+cal_viz_internal.
                     ...
                     //_|tb
                        ...
                        //_@2
                           assign {FpgaPins_Fpga_TB_mem_a2[7:0], FpgaPins_Fpga_TB_op_a2[3:0], FpgaPins_Fpga_TB_out_a2[7:0], FpgaPins_Fpga_TB_val1_a2[7:0], FpgaPins_Fpga_TB_val2_a2[7:0], FpgaPins_Fpga_TB_valid_a2} = {FpgaPins_Fpga_CALC_mem_a2, FpgaPins_Fpga_CALC_op_a2, FpgaPins_Fpga_CALC_out_a2, FpgaPins_Fpga_CALC_val1_a2, FpgaPins_Fpga_CALC_val2_a2, FpgaPins_Fpga_CALC_valid_a2};
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 175 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
