...
logic [31:0] FpgaPins_Fpga_CALC_cnt_a0,
             FpgaPins_Fpga_CALC_cnt_a1;
...
logic [7:0] FpgaPins_Fpga_CALC_out_a0,
            FpgaPins_Fpga_CALC_out_a1;
logic [3:0] FpgaPins_Fpga_CALC_out_a2,
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $cnt.
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_cnt_a1[31:0] <= FpgaPins_Fpga_CALC_cnt_a0[31:0];

            // Staging of $out.
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_out_a1[7:0] <= FpgaPins_Fpga_CALC_out_a0[7:0];
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_out_a2[3:0] <= FpgaPins_Fpga_CALC_out_a1[3:0];
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_out_a3[3:0] <= FpgaPins_Fpga_CALC_out_a2[3:0];
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               assign \///@0$cnt = FpgaPins_Fpga_CALC_cnt_a0;
               (* keep *) logic [7:0] \///@0$diff ;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 149 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 152 as: m5+board(/top, /fpga, 7, $, , calc)
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 154 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
